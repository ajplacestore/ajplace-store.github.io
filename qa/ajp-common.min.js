    ...
    try {
        ...
        let Common = {
            ...
            headerConfig: () => {
                ...
                $("#ajp-button-hamburguer").on("click", function() {
                    $(document.body).addClass("ajp-mmobile-opened");
                });

                $(".ajp-mmobile").on("click", function(e) {
                    if ($(e.target).is(this)) {
                        $(document.body).removeClass("ajp-mmobile-opened");
                    }
                });
