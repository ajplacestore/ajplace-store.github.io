    ...
    try {
        ...
        let NewProduct = {
            ...
            applySlickHorizontalMobile: () => {
                ...
                if (wrapperThumbs.children().length < 3) {
            ...
            getSkuSellers: () => {
                ...
                // Quando o produto tem apenas 1 SKU
                    ...
                    // let thisSkuSellers = NewProduct.productData.items[0].sellers;
                    ...
                    thisSkuSellers[0].sellers.forEach(seller => {
                        ...
                        groupSellerElement = groupSellerElement + thisBlock;
                        wrapper.html(`<form data-sku-id="${skuJson.skus[0].sku}">${groupSellerElement}</form>`);
                    });
            ...
            applyDiscountPerTicket: () => {
                ...
                let wrapperPrice = $(".preco-a-vista.price-cash");
